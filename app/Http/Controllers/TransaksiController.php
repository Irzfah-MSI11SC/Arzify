...
class TransaksiController extends Controller
{
    ...
    /**
     * SIMPAN TRANSAKSI
     * - Simpan uang_tunai & kembalian ke DB
     */
    public function simpan(Request $r)
    {
        ...
        try {
            $trxId = DB::transaction(function () use ($cart, $kasirId, $total, $r, $uangTunai, $kembalian) {
                ...
                // ✅ SIMPAN transaksi (sekaligus uang_tunai & kembalian)
                $trx = Transaksi::create([
                    'idkasir'      => $kasirId,
                    'tanggal'      => Carbon::now(),
                    'total'        => (float) $total,
                    'metode_bayar' => $r->metode_bayar,
                    'uang_tunai'   => $r->metode_bayar === 'tunai' ? $uangTunai : null,
                    'kembalian'    => $r->metode_bayar === 'tunai' ? $kembalian : 0,
                ]);
